...
class RT1(Module):
    ...
    def __init__(
        ...
        *,
        ...
        # 将 Backbone 换成了 MaxViT（比论文里的 EfficientNet 更现代）
        self.vit = vit
        ...
        # 3. 动作输出头 (Action Head) 将 Transformer 的维度映射到 (11 * 256)
    ...
    def forward(
        ...
        # --- A. 视觉特征提取 ---
        # 这一步把视频帧喂给 Backbone
        # 输出 features 形状: [Batch * Frames, Feature_H, Feature_W, Dim]
        tokens = self.vit(
            images,
            texts = texts,
        ...
        # --- B. TokenLearner 压缩 ---
        # 这里对应论文核心：把 H*W 的特征图压缩成 8 个 Token
        # 输出: [Batch, Frames * 8, Dim]
